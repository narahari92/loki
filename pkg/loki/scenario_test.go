...
func TestScenario(t *testing.T) {
	...
	require.Equal(t, Identifiers{TestIdentifier("resource2"), TestIdentifier("resource3")}, scenarios[1])
	...
	require.NotEqual(t, Identifiers{TestIdentifier("resource1"), TestIdentifier("resource2")}, scenarios[2])
	require.NotEqual(t, Identifiers{TestIdentifier("resource2"), TestIdentifier("resource1")}, scenarios[2])
	...
	require.NotEqual(t, Identifiers{TestIdentifier("resource3"), TestIdentifier("resource2")}, scenarios[3])
	require.NotEqual(t, Identifiers{TestIdentifier("resource1")}, scenarios[3])
	require.NotEqual(t, Identifiers{TestIdentifier("resource1"), TestIdentifier("resource2")}, scenarios[3])
	require.NotEqual(t, Identifiers{TestIdentifier("resource2"), TestIdentifier("resource1")}, scenarios[2])
